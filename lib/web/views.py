...
from ..yellowant_api.models import UserIntegration,Agile_Credentials
...
def userdetails(request):
    ...
    if request.user.is_authenticated:
        ...
        for user_integration in user_integrations:
            ...
            smut = Agile_Credentials.objects.get(user_integration_id=user_integration.id)

            if smut.AGILE_UPDATE_LOGIN_FLAG == True:
                print("TEST",smut.AGILE_UPDATE_LOGIN_FLAG)
                smut = Agile_Credentials.objects.get(user_integration_id=user_integration.id)
